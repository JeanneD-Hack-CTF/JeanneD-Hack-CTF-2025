...
NOMS_CARTES = ["david", "pallas", "ogier", "charles", "judith", "lahire", "cesar", "rachel", "hector", "alexandre", "argine", "lancelot"] # roi de pique - valet de trèfle (pique, coeur, carreau, trèfle)
...
with open('Fichier_joint_au_message_8_cameras.csv') as csvfile:
